...
/*						
 *						MEMORAMA EN JAVA UTILIZANDO EVENTOS DE MOUSE
 *ELABORADO POR:
 *	
 *				TIC - 51
 *	
 *		
 *
 *							FECHA DE ELABORACION:02/JUNIO/2008
 *								ULTIMA MODIFICACION:11/AGOSTO/2008
 *
 *																								VERSION: 5.2 beta
 *
 *DESCRIPCION: 	El programa trabaja con 8cartas diferentes conlas cuales gerera 8 pares, las coloca en forma 
 *				aleatoria dentro de la matriz, al dar click sobre alguna posicion de la matriz muestra la carta 
 *				que se le fue asignada en el profeso del RANDOM. hasta que se encuentre la pareja de la carta 
 *				estas casillas se deshabilitaran.
 */
