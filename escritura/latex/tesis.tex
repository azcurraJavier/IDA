...
%En lo que respecta a la implantación, el algoritmo forma parte de una herramienta de interpretación de ids. En primera instancia extrae los ids de los códigos a traves de un scanner elaborado a medida. Este lexer se modificó...
