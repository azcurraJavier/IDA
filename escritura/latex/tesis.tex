...
Habiendo planteado el proceso que se necesita para llevar una expansión de ids a palabras completas, el siguiente paso es describir las herramientas que los implementan. 
...
Por ejemplo el verbo expresa la acción y el sustantivo representa al objeto de la acción, con \textbf{ActionOnObject} $\Rightarrow$ $<$verb$>$,$<$noun$>$ $\equiv$ $<$go,home$>$. Otro ejemplo es, el adjetivo representa una cualidad del sustantivo \textbf{IndirectAction} $\Rightarrow$ $<$adjetive$>$,$<$noun$>$ $\equiv$ $<$order,textfield$>$.
