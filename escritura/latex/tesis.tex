...
Construir herramientas de CP que se encargan de analizar ids en los códigos fuentes de los programas son importantes de llevar a cabo. 
...
Por ende en el ámbito de CP los ids son una fuente importante de información que el futuro lector del código o encargado de mantenimiento debe tener en cuenta. 
...
Por lo tanto si los ids están bien nombrados se pueden descubrir los conceptos que representan en el dominio del programa mas fácilmente y de esta manera agiliza la comprensión del código, aumenta la productividad, mejora la calidad durante la etapa de mantenimiento \cite{DFPM05}.
...
%%=========Lawrie
\pagebreak
La buena calidad en el nombramiento de los ids descripta anteriormente abre la posibilidad de construir herramientas que ejecuten técnicas de regresión para traducir los ids a palabras conocidas.
