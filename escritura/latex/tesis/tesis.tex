...
\input{./init-libro/init-libro.tex}
...
\addtocontents{lof}{\protect\addcontentsline{toc}{chapter}{Índice de figuras}}
\listoffigures % índice de figuras

\addtocontents{lot}{\protect\addcontentsline{toc}{chapter}{Índice de tablas}}
\listoftables % índice de figuras


%CAPÍTULO 1=============================================================
\chapter{Introducción: Problema y Solución}
\input{./cap1/cap1-intro.tex}
%
%%%CAPÍTULO 2=============================================================
%\setcounter{chapter}{1}
%
\chapter{Comprensión de Programas}
\input{./cap2/cap2-comp.tex}
%
%%%CAPÍTULO 3=============================================================
%\setcounter{chapter}{2}
\chapter{Análisis de Identificadores: Estado del Arte}
\input{./cap3/cap3-analisis.tex}
%
%%%CAPÍTULO 4=============================================================
%\setcounter{chapter}{3}
\chapter{Identifier Analyzer (IDA)}
\input{./cap4/cap4-ida.tex}

%%CAPÍTULO 5=============================================================
%\setcounter{chapter}{4}
\chapter{Casos de Estudio}
\input{./cap5/cap5-ida-ce.tex}
