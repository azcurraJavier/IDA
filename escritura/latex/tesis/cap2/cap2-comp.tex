...
Los Modelos Cognitivos están compuestos por: \textit{Conocimientos}, \textit{Modelos Mentales} y \mbox{\textit{Procesos de Asimilación} \cite{MBPHRU10}.}
...
Por último, el proceso \textit{híbrido} combina los dos conceptos mencionados \textit{top-down} y \textit{bottom-up}. Durante el proceso de aprendizaje del sistema, con el proceso \textit{híbrido}, el programador combina libremente ambas políticas (\textit{top-down} y \textit{bottom-up}) hasta lograr comprender el sistema.
