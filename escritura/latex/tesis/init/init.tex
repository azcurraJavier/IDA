...
\columnbreak
\begin{flushright}
\textit{“Hay en el mundo un lenguaje que todos comprenden: es el lenguaje del entusiasmo, de las cosas hechas con amor y con voluntad, en busca de aquello que se desea o en lo que se cree.”\linebreak Paulo Coelho}
\end{flushright}
\end{multicols}
