...
En este capítulo se redacta un problema encontrado en el ámbito del análisis de los identificadores (ids) presentes en códigos, este problema surgió en base a las investigaciones realizadas. Luego se proponen algunos aportes a la solución de este problema y en función es esto, cuales son las contribuciones. Para comenzar con este capítulo, se explican algunas características involucradas al desarrollo de los sistemas de software.
...
Sin duda, los comentarios tienen como principal finalidad ayudar a comprender un segmento de código \cite{JDPH08,ACCL02,AMPM12}. Por esta razón, se puede ver a los comentarios como una herramienta natural para entender el significado de los ids en el código, como así también el funcionamiento del sistema.
...
Normalmente estas herramientas para realizar sus tareas, efectúan la traducción de ids, e involucran los siguientes pasos: \\I) capturar los ids del código, II) dividir las palabras abreviadas que componen un id, III) expandir las abreviaturas en base a lo observado en comentarios/literales y/o diccionarios, etc. 
...
La herramienta IDA, además de analizar ids, puede ser utilizada como base para construir futuras implementaciones en este mismo contexto.
